...
import { postgresqlDataProvider } from "./providers/postgresql-data-provider";
          ...
          >
            <Routes>
              ...
              >
                ...
                <Route path="/database/connection" element={<DatabaseConnectionPage />} />

                <Route path="/tables">
                  <Route index element={<TablesList />} />
                  <Route path=":tableName">
                    <Route index element={<DynamicTableList />} />
                    <Route path="create" element={<DynamicTableCreate />} />
                    <Route path="edit/:id" element={<DynamicTableEdit />} />
                  </Route>
                </Route>
              </Route>
